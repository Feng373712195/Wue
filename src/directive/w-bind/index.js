...
import { isArray,isEmptyObject,isObject,isString,serialize } from '../../uilt'
...
const wbind = (vnode,propkey,data,wue) => {
    ...
    const isStrObject = (modle) =>{
        return modle[0] === '{' && modle[modle.length-1]  === '}'
    }
